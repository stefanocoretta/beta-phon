...
the modelling of unit interval data, i.e.~data that is in the interval
...
\citet{bockting2024}, \citet{mikkola2024} and the Wiki page
https://github.com/stan-dev/stan/wiki/Prior-Choice, and
\citet[p.~82-84]{mcelreath2020}.
...
central limit theorem). Bayesian Credible Intervals (CrIs) can be
...
Table~\ref{tbl-marginal-2}. Note that even when multiple comparisons are
made, there is no need to apply any correction as it is commonly done
with \emph{p}-values in frequentist statistics
\citep[see][]{gelman2012}.
